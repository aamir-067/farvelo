...
export function Footer() {
    return (
        <footer className="w-full md:px-10 mt-40 mb-6">
            ...
            <div className="mx-auto max-w-6xl items-center justify-between px-4 md:flex lg:px-0">
                <div className="inline-flex items-center">
                    <Image src={Logo} alt="logo of agency" />
                    <span className="ml-4 text-lg font-bold">Farvelo</span>
                </div>
                <div className="mt-4 md:mt-0">
                    <p className="text-sm font-medium text-gray-500">© 2024 Farvelo. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
